...
function Previewer() {
  ...
  const handleMinMax = () => {
    ...
    if(previewerDisplay){
      ...
      styles = {
        mainDiv: "h-24 w-24 bg-teal-900 shadow-2xl transition-all ease-in-out duration-300 fixed right-0 top-1/2 transform -translate-y-1/2 rounded-tl-xl rounded-bl-xl",
